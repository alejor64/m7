  ...
  submenu: [
    {
      ...
      path: `${APP_PREFIX_PATH}/dashboards/escritorio`,
      title: 'sidenav.dashboard.graficos',
      icon: BarChartOutlined,
      breadcrumb: false,
      submenu: []
    },
    {
      key: 'dashboards-pedidos',
      path: `${APP_PREFIX_PATH}/dashboards/pedidos`,
      title: 'sidenav.dashboard.pedidos',
      icon: DashboardOutlined,
      breadcrumb: false,
      submenu: []
    },
    {
      key: 'dashboards-cliente',
      path: `${APP_PREFIX_PATH}/dashboards/cliente`,
      title: 'sidenav.pages.cliente',
      icon: UserOutlined,
      breadcrumb: false,
      submenu: []
    },
